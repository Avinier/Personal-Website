          ...
          <div className="relative flex justify-around items-center max-[786px]:flex-col-reverse">
            <div className="w-[40%] max-[786px]:w-[80%] max-[786px]:pt-[20px] z-10">
              ...
              <motion.p className="text-slate-50 dark:text-slate-700 text-[18px]">
                I'm most active in <Link isHref={true}>Elon's Kingdom</Link>, or you can find me chilling with{" "} 
                <Link isHref={true}>wumpus</Link> or <Link isHref={true}>IG</Link>. And if you wanna keep it damn real, <Link isHref={true}>mail me!</Link>.
                You can stalk my <Link isHref={true}>graphic design work</Link> too :D. I'm always open to fun conversations and cool work.
              </motion.p>
            </div>
            <img
              src={connectImg}
